...
const CreatorProfile = ({ 
  ...
  return (
    <div className="flex flex-row md:flex-col items-center md:justify-center gap-4 md:gap-5 p-3 sm:p-5 bg-[#E07755]/5 border border-[#E07755]/15 rounded-2xl w-full">
      ...
      >
        <span className="text-[16px] sm:text-[28px] font-bold" style={{ color: "#E07755" }}>{initials}</span>
      </div>
      <div className="flex flex-col items-start md:items-center text-left md:text-center">
        <span className="uppercase text-[#E07755] mb-1 tracking-[2px] sm:tracking-[3px] text-[7px] sm:text-[9px]">
          Made By
        </span>
        <h3 className="font-bold text-[#f3f4f6] mb-0.5 text-[12px] sm:text-[16px]" style={{ textShadow: "0 0 10px rgba(255,255,255,0.2)" }}>
          {name}
        </h3>
  ...
  if (!game) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center">
        <h1 className="text-xl mb-4" style={{ color: "#E07755" }}>GAME NOT FOUND</h1>
        <Link
          to="/explore"
    ...
    <div className="w-full h-fit md:h-full flex flex-col md:flex-row gap-8 md:gap-8 pb-10 pt-1">
      ...
      <div className="w-full md:flex-1 flex flex-col justify-between gap-6">
        <section className="flex flex-col gap-4">
          <h1 
            ...
            style={{ fontSize: "clamp(18px, 4vw, 30px)", textShadow: "0 0 15px #E0775566" }}
          >
            {game.name}
          </h1>
          <p 
      ...
      <div className="w-full md:flex-1 flex flex-col justify-between gap-6 border-t md:border-t-0 md:border-l border-[#E07755]/10 pt-10 md:pt-0 md:pl-8">
        <div className="w-full flex flex-col justify-center items-center bg-[#E07755]/5 border border-[#E07755]/20 rounded-2xl p-8 text-center min-h-[160px] md:flex-1">
          <span className="text-[#8a7a60] uppercase mb-2 tracking-[2px]" style={{ fontSize: "8px" }}>High Score</span>
          <h2 className="text-[#4ade80]" style={{ fontSize: "clamp(28px, 5vw, 44px)", textShadow: "0 0 12px #4ade8066" }}>
            {game.highScore}
          </h2>
        </div>

        <div className="flex gap-3 h-14 sm:h-16 shrink-0 mt-6 md:mt-0">
          <button className="w-14 sm:w-16 h-full bg-[#E07755]/10 border border-[#E07755]/30 rounded-lg flex items-center justify-center hover:bg-[#E07755]/20 transition-colors">
            <img 
              src="/leaderboard .png" 
              alt="lb" 
          ...
          <div className="flex-1 bg-[#E07755]/10 border border-[#E07755]/30 rounded-lg flex justify-between items-center px-4">
            <button className="opacity-60 hover:opacity-100 hover:scale-110 transition-all">
              <img src="/arrow-back.png" alt="b" className="w-4 h-4 brightness-0 invert" />
            </button>
            <Link to="/explore" className="text-[#E07755] font-bold text-[9px] sm:text-[10px] tracking-[2px] sm:tracking-[3px]">EXPLORE</Link>
            <button className="opacity-60 hover:opacity-100 hover:scale-110 transition-all">
              <img src="/arrow-forward.png" alt="f" className="w-4 h-4 brightness-0 invert" />
            </button>
          </div>
        </div>
      </div>
